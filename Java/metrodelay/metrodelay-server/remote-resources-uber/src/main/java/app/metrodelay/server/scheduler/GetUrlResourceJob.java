...
public class GetUrlResourceJob implements Job {
  ...
  public void execute(JobExecutionContext context) throws JobExecutionException {
    ...
    try {
      ...
      var cachedFingerprint = operatorCache.get(operatorId);
      l.debug("operator '{}' resource '{}' cached fingerpring '{}'", operatorId, uri, cachedFingerprint);
      l.debug("getting resource '{}'", uri);
      var resource = resourceService.resource(uri.toURL(), cachedFingerprint);
